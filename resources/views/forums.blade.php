    ...
    @foreach($discussion as $d )
      <div class="card border-info">
          <div class="card-header">
            <img src="{{ $d->user->avatar }}" width="60px" height="60px" alt="{{ $d->slug }}">
          ...
          <div class="card-footer text-muted">
            ...
            <a href="{{ route('channels.show', ['slug'=>$d->channel->slug]) }}" class="btn btn-outline-info btn-sm pull-right" > <i class="fa fa-tags"></i> {{ $d->channel->title }}</a>
